        ...
        <div className="w-full max-w-md mx-auto border border-gray-60  rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          >
            ...
            <div className="relative w-full h-0.5">
              <button
                onClick={swap}
                className="absolute left-1/2 -translate-x-1/2 border-2 border-white rounded-md bg-red-500/70 text-white px-2 py-0.5 -translate-y-1/2"
              >
                Swap
              </button>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-red-500/75 shadow-md text-white px-4 py-3 rounded-lg mt-2"
            >
